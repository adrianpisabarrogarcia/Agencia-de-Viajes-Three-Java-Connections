...
public class MySQL {
    ...
    public static void desconectar(Connection conexion) {
        try {
            ...
            System.out.println("Error al desconectar de la base de datos MySQL");
            throw new RuntimeException(e);
        }
    }
    ...
    public static void insertar(String SQL) {
        try {
            ...
            System.out.println("Error al insertar en MySQL");
            throw new RuntimeException(e);
        }
    }
    ...
    public static void modificar(String SQL) {
        try {
            ...
            System.out.println("Error al modificar en MySQL");
            throw new RuntimeException(e);
        }
    }
    ...
    public static void eliminar(String SQL) {
        try {
            ...
            System.out.println("Error al eliminar en MySQL");
            throw new RuntimeException(e);
        }
    }
    ...
    public static ResultSet consultar(String SQL) {
        try {
            ...
            System.out.println("Error al consultar en MySQL");
            throw new RuntimeException(e);
        }
    }
